...
def parse_args():
    ...
    parser.add_argument('--hidden_units',dest='hidden_units', type = int, default='512',help = 'enter # of hidden units')
...
def main():
    ...
    if args.arch == "vgg13":
        ...
        classifier = nn.Sequential(OrderedDict([
                                  ...
                                  ('relu', nn.ReLU()),
                                  ('fc2', nn.Linear(args.hidden_units, len(image_datasets[0].class_to_idx))),
